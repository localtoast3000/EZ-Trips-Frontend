...
export default function SearchIcon({ scale = 1, stroke = 1, color = 'black', onPress }) {
  ...
  return (
    ...
    >
      <Path
        d='M32.0833 55.4167C44.97 55.4167 55.4167 44.97 55.4167 32.0833C55.4167 19.1967 44.97 8.75 32.0833 8.75C19.1967 8.75 8.75 19.1967 8.75 32.0833C8.75 44.97 19.1967 55.4167 32.0833 55.4167Z'
        stroke={color}
        strokeWidth={stroke}
        strokeLinecap='round'
      ...
      />
      <Path
        d='M61.25 61.25L48.5625 48.5625'
        stroke={color}
        strokeWidth={stroke}
        strokeLinecap='round'
        strokeLinejoin='round'
